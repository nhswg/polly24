<template>
  <div class="game-buttons">
    ...
    <button class="button-container" @click="changeStrokeColor('#724a33')"><img src="/img/724a33.png" alt="Brown" /></button>
    <button class="button-container" @click="changeStrokeColor('#EC1C24')"><img src="/img/ec1c24.png" alt="Red" /></button>
    <button class="button-container" @click="changeStrokeColor('#ff7f27')"><img src="/img/ff7f27.png" alt= "Orange"></button>
    <button class="button-container" @click="changeStrokeColor('#fff200')"><img src="/img/fff200.png" alt="Yellow" /></button>
    <button class="button-container" @click="changeStrokeColor('#0dae3b')"><img src="/img/0dae3b.png" alt= "Green"></button>
    <button class="button-container" @click="changeStrokeColor('#3f48cc')"><img src="/img/3f48cc.png" alt="Blue" /></button>
    <button class="button-container" @click="changeStrokeColor('#8cfffb')"><img src="/img/8cfffb.png" alt="Lightblue" /></button>
    ...
    <button class="button-container" @click="changeLineWidth('20')"><img src="/img/4.jpg" alt="linewidth 20" /></button>
